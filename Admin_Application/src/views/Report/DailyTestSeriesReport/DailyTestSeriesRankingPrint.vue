<template>
    ...
    <div class="holds-the-iframe">
        <iframe :src="dailyTestSeriesRanking" width="100%" height="90%" frameborder="0"></iframe>
    </div>
</template>
<script>
...
export default {
    ...
    setup() {
        ...
        const dailyTestSeriesRanking = ref('');
        ...
        const loadPdf = async () => {
            ...
            axios.get(BASE_URL + `admin/reports/daily-test-series/ranking/pdf/${route.params.id}`, {
            ...
            .then(function (response) {
                ...
                dailyTestSeriesRanking.value = window.URL.createObjectURL(blob);
            })
