<template>
	...
	<div class="card">
		...
		<div class="card-body">
			<div class="row mb-3">
				...
				<div class="col-sm-6 mb-3">
					...
					<input id="phoneInput" type="text" v-model="phoneNumber" class="form-control" :class="{'is-invalid': errors.phone_no}" placeholder="Enter Phone Number" aria-label="Phone Number" />
					<p v-if="errors.phone_no" class="error-message">{{ errors.phone_no[0] }}</p>
				</div>
				<!-- Role -->
				<div class="col-sm-6 mb-3">
					<label for="roleSelect" class="form-label">Role</label>
					<select id="roleSelect" class="form-select" :class="{'is-invalid': errors.role}" v-model="roleValues" aria-label="Select Role">
				...
				<div class="col-sm-6 mb-3">
					...
					<select id="statusSelect" class="form-select" :class="{'is-invalid': errors.status}" v-model="status">
		...
		<div class="card-footer text-center">
			<button class="btn btn-primary me-2" @click="submitUser">Submit</button>
...
export default {
	...
	setup() {
		...
		const submitUser = () => {
			...
			axios.post(BASE_URL+'admin/user-management', {
