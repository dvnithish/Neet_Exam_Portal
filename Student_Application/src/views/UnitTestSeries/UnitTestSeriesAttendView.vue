    ...
    setup() {
        ...
        const startTest = async () => {
            ...
            .then(function(response) {
                ...
                if (unitTestSeries.value.is_finished) {
                    router.push({ path: `/unit-test-series` });
                }
        ...
        const selectChoice = async (questionId, choiceId) => {
            ...
            isChoiceUploaded.value = 0;
            var tapasyaStudentToken = localStorage.getItem("tapasya_student_token");
            axios.post(BASE_URL+`student/unit-test-series-student-answer`, {
                unit_test_series_id: unitTestSeries.value.id,
        ...
        const updateTime = () => {
            ...
            const targetDate = new Date(unitTestSeries.value.end);
        ...
        const finishTest = () => {
            ...
            setTimeout(() => {
                ...
                router.push({ path: `/unit-test-series/result/${route.params.id}` });
            }, 300);
        }
